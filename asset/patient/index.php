        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td width="15%">
                                ...
                                <?php 
                                    ...
                                    $apptoday = selectAppointmentToday($database, $today);
                                    $schetoday = selectScheduleToday($database, $today);
                ...
                <tr>
                    ...
                    <center>
                    <table class="filter-container patient-header" style="background-image: url(../img/patient-bg.png); border: none;width:95%" border="0" >
                    <tr>
                        <td >
                            <h3>Welcome!</h3>
                            <h1><?php echo $username  ?>.</h1>
                            <p>နေထိုင်မကောင်းလို့ ဘယ် Doctor နဲ့ပြရမလဲ စဥ်းစားလို့မရဘူးလား? စိုးရိမ်မနေပါနဲ့! <br>
                                ကျွန်တော်တို့ Doctor Appointment ရဲ့ 
                                <a href="./doctors.php" class="non-style-link"><b>"All Doctors"</b></a> section နဲ့ 
                                <a href="./schedule.php" class="non-style-link"><b>"Sessions"</b></a> မှာ ၀င်ရောက်စပ်စုလိုက်ပါ.<br>
                                    ...
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                $sqlmain= "select * from schedule inner join appointment on schedule.sid=appointment.sid inner join patient on patient.pid=appointment.pid inner join doctor on schedule.did=doctor.did  where  patient.pid=$userid  and schedule.sdate>='$today' order by schedule.sdate asc";
                                                //echo $sqlmain;

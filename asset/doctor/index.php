        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                ...
                <tr>
                    ...
                    <center>
                    <table class="filter-container doctor-header" style="background-image: url(../img/doctor-bg.png); border: none;width:95%" border="0" >
                    <tr>
                        <td >
                            <h3>Welcome!</h3>
                            <h1><?php echo $username;  ?>.</h1>
                            <p>Thanks for joinnig with us. <br>
                                သင့်အား ပြီးပြည့်စုံသော ဝန်ဆောင်မှုများ ပေးနိုင်ရန် ကျွန်ုပ်တို့ အမြဲကြိုးစားနေပါသည်.<br>

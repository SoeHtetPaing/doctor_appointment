...
<body>
    ...
    $doctor = selectDoctorByEmail($database, $useremail);
    $userid = $doctor["did"];
    $username = $doctor["dname"];
                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                <td width="25%" style="padding-left:20px" >
                                    <img src="../img/doctor-pp-v1.jpg" alt="" width="100%"  style="border: 2px solid #d8ebfa; border-radius:50%">
                                </td>
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a href="./deleteAccount.php?id='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Yes&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
            ...
            $result= selectDoctorById($database, $id);
            $name=$result["dname"];
            $email=$result["demail"];
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <form action="editAccount.php" method="POST" class="add-new-form">
                                            <label for="Email" class="form-label">Email: </label>
            ...
            echo '
                <div id="popup1" class="overlay">
                        ...
                        <br><br><br><br>
                            ...
                            <a href="../auth/logout.php" class="non-style-link"><button  class="btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;Log out&nbsp;&nbsp;</font></button></a>

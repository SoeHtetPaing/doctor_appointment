...
<body>
    ...
    <div class="container">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td width="15%">
                        ...
                        <?php 
                            ...
                            $list110 = selectScheduleByDoctorId($database, $userid);
                ...
                $sqlmain= "select schedule.sid,schedule.title,doctor.dname,schedule.sdate,schedule.stime,schedule.nop from schedule inner join doctor on schedule.did=doctor.did where doctor.did=$userid ";
                    if($_POST){
                        //print_r($_POST);
                        $sqlpt1="";
                        if(!empty($_POST["sheduledate"])){
                            $sheduledate=$_POST["sheduledate"];
                            $sqlmain.=" and schedule.sdate='$sheduledate' ";
                        }
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            $result= selectScheduleDetailById($database, $id);
            ...
            $result12= selectAppointmentDetailById($database, $id);
            echo '
            <div id="popup1" class="overlay">

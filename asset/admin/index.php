            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td width="15%">
                                ...
                                $appointments = selectAppointmentToday($database, $today);
                                $schedules = selectScheduleToday($database, $today);
                        ...
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    ...
                                    တစ်ပါတ်စာ 7 ရက်အတွက် patient များ၏ ချိန်းဆိုမှုများကို ပြသထားပါသည်။<br>
                                    အသေးစိတ်အချက်အလက်များကို @Appointment တွင် ကြည့်ရှုပါ။<br>
                                    </p>
                                ...
                                <td>
                                    ...
                                    တစ်ပါတ်စာ 7 ရက်အတွက် doctor များ၏ schedule session များကို ပြသထားပါသည်။<br>
                                    Session ဖျက်ခြင်း၊ ထည့်ခြင်း လုပ်ငန်းစင်များကို @Schedule တွင် လုပ်ဆောင်လိုက်ပါ။
                                    </p>
                                </td>
                            </tr>
                            <tr>

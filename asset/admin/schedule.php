            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td width="15%">
                        ...
                        $list110 = selectAllSchedule($database);
                ...
                <?php
                    if($_POST){
                        ...
                        if(!empty($_POST["docid"])){
                            $docid=$_POST["docid"];
                            $sqlpt2=" doctor.did=$docid ";
                        }
                        //echo $sqlpt2;
                        //echo $sqlpt1;
                        $sqlmain= "select schedule.sid,schedule.title,doctor.dname,schedule.sdate,schedule.stime,schedule.nop from schedule inner join doctor on schedule.did=doctor.did ";
                        ...
                        $sqlmain= "select schedule.sid,schedule.title,doctor.dname,schedule.sdate,schedule.stime,schedule.nop from schedule inner join doctor on schedule.did=doctor.did  order by schedule.sdate desc";
                       ...
                       <center>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $result = filterSchedule($database, $sqlmain);
        ...
        if($action=='add-session'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                <form action="./addSchedule.php" method="POST" class="add-new-form">
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div style="display: flex;justify-content: center;">
                        <a href="./deleteSchedule.php?id='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Yes&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
            ...
            $schedule = selectScheduleDetailById($database, $id);
            $docname=$schedule["dname"];
            $scheduleid=$schedule["sid"];
            $title=$schedule["title"];
            $scheduledate=$schedule["sdate"];
            $scheduletime=$schedule["stime"];
            
           
            $nop=$schedule['nop'];

            $appointment = selectAppointmentDetailById($database, $id);
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label"><b>Patients that Already registerd for this session:</b> ('.$appointment->num_rows."/".$nop.')</label>
                                    <br><br>
                                </td>
                            </tr>
